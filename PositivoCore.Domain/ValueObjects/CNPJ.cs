...
namespace PositivoCore.Domain.ValueObjects
{
    public class CNPJ : Notifiable
    {
        public CNPJ(string number)
        {
            ...
            AddNotifications(new Contract()
                .HasMaxLen(Number, 14, "CNPJ", "CNPJ Inválido!")
                .IsTrue(ValidarCNPJ(Number), "CNPJ", "CNPJ Inválido!")
            );
        }
        public CNPJ() { }
        ...
        public static bool ValidarCNPJ(Cnpj cnpj) => cnpj.EhValido;
